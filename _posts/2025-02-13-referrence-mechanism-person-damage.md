...
回复速度
: 法力值回复速度和**天赋**以及**等级**相关，也可以长按/右击/武器和套装快速回复法力值。
...
| 10      | **再生** | 每 10 秒为 18 半径内血量最少玩家回复 `{0}` 点血量           | 仅职业天赋生效：`等级 * 20 / 40`                              |
...
| ------------------- | ------- | ----------- | ---------------- |
| **守卫 (Guard)**    | 1       | 1, 3        | 高血量与真实伤害 |
| **战士 (Warrior)**  | 2       | 4, 5        | 近战攻防皆备     |
| **刺客 (Assassin)** | 3       | 4, 9        | 近战高爆发       |
| **弓箭手 (Archer)** | 4       | 2, 3        | 远程输出         |
| **术士 (Warlock)**  | 5       | 8, 11       | 法术类高伤害     |
| **牧师 (Priest)**   | 6       | 8, 10       | 群体治疗         |
